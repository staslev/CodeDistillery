...
public class Compiler implements Opcodes {
  ...
  // symbol->localbinding
  public static Var LOCAL_ENV = Var.create(null);
  // vector<localbinding>
  public static Var LOOP_LOCALS = Var.create();
  // Label
  public static Var LOOP_LABEL = Var.create();
  // vector<object>
  public static Var CONSTANTS = Var.create();
  // keyword->constid
  public static Var KEYWORDS = Var.create();
  // var->constid
  public static Var VARS = Var.create();
  // FnFrame
  public static Var METHOD = Var.create(null);
  // String
  public static Var SOURCE = Var.create(null);
  // String
  public static Var SOURCE_PATH = Var.create(null);
  // Integer
  public static Var LINE = Var.create(0);
  // Integer
  public static Var NEXT_LOCAL_NUM = Var.create(0);
  // Integer
  public static Var RET_LOCAL_NUM = Var.create();
  // DynamicClassLoader
  public static Var LOADER = Var.create();
  public static IPersistentMap CHAR_MAP =
      PersistentHashMap.create(
          ...
          '\\', "_BSLASH_",
          '?', "_QMARK_");
  static IPersistentMap specials =
      RT.map(
          DEF,
          new DefExpr.Parser(),
          LOOP,
  ...
  static int getMatchingParams(ArrayList<Class[]> paramlists, IPersistentVector argexprs)
      throws Exception {
  ...
  public static Object loadFile(String file) throws Exception {
    ...
    try {
      Var.pushThreadBindings(RT.map(SOURCE_PATH, file, SOURCE, (new File(file)).getName()));
  ...
  public static Object load(Reader rdr) throws Exception {
    ...
    try {
      ...
      for (Object r = LispReader.read(pushbackReader, false, EOF, false);
          r != EOF;
          r = LispReader.read(pushbackReader, false, EOF, false)) ret = eval(r);
    } finally {
      Var.popThreadBindings();
    }
    return ret;
  ...
  static class DefExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      ...
      } else gen.visitInsn(Opcodes.ACONST_NULL);
  ...
  static class TheVarExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      if (context != C.STATEMENT) fn.emitVar(gen, var);
    }
  ...
  static class KeywordExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      if (context != C.STATEMENT) fn.emitKeyword(gen, k);
    }
  ...
  abstract static class HostExpr implements Expr {
    ...
    private static Class maybeClass(Object form, boolean stringOk) throws Exception {
      ...
      if (form instanceof Symbol) {
        ...
        {
          if (sym.name.indexOf('.') > 0 || sym.name.charAt(0) == '[') c = Class.forName(sym.name);
          else {
            Object o = currentNS().getMapping(sym);
            if (o instanceof Class) c = (Class) o;
          }
        }
      } else if (stringOk && form instanceof String) c = Class.forName((String) form);
      return c;
    }
    ...
    */
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) throws Exception {
        ...
        } else throw new IllegalArgumentException("Malformed member expression");
      }
    }
  }
  ...
  static class InstanceFieldExpr extends FieldExpr implements AssignableExpr {
    static final Method getInstanceFieldMethod =
        Method.getMethod("Object getInstanceField(Object,String)");
  ...
  static class NilExpr extends LiteralExpr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      if (context != C.STATEMENT) gen.visitInsn(Opcodes.ACONST_NULL);
    }
  ...
  static class TryExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      ...
      if (finallyExpr != null) gen.visitTryCatchBlock(startTry, endTry, finallyLabel, null);
    ...
    static class Parser implements IParser {
      ...
      public Expr parse(C context, Object frm) throws Exception {
        ...
        return new TryExpr(
            (new BodyExpr.Parser()).parse(context, RT.seq(body)), catches, finallyExpr);
      }
    }
  }
  ...
  static class EmptyExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      if (context != C.STATEMENT) {
        if (coll instanceof IPersistentList) gen.getStatic(LIST_TYPE, "EMPTY", LIST_TYPE);
  ...
  static class InvokeExpr implements Expr {
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      ...
      gen.invokeInterface(
          IFN_TYPE,
          new Method(
              "invoke", OBJECT_TYPE, ARG_TYPES[Math.min(MAX_POSITIONAL_ARITY, args.count())]));
      if (context == C.STATEMENT) gen.pop();
    }
  ...
  static class FnExpr implements Expr {
    ...
    static Expr parse(C context, ISeq form, String name) throws Exception {
      ...
      fn.simpleName = (name != null ? munge(name) : ("fn__" + RT.nextID()));
    ...
    public void emit(C context, FnExpr fn, GeneratorAdapter gen) {
      ...
      if (context != C.STATEMENT) {
        ...
        gen.invokeConstructor(
            fntype, new Method("<init>", Type.VOID_TYPE, ARG_TYPES[closes.count()]));
      }
    }
  ...
  static class BodyExpr implements Expr {
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frms) throws Exception {
        ...
        if (RT.equal(RT.first(forms), DO)) forms = RT.rest(forms);
