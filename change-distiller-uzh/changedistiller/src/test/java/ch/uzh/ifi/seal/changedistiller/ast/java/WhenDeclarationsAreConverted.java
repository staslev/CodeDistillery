...
public class WhenDeclarationsAreConverted extends WhenASTsAreConverted {
  ...
  @Test
  public void fieldDeclarationWithParameterizedQualifiedTypeParameterShouldBeConverted()
      throws Exception {
  ...
  @Test
  public void fieldDeclarationWithQualifiedParameterizedTypeParameterShouldBeConverted()
      throws Exception {
  ...
  public void methodDeclarationWithOneParameterShouldBeConverted() throws Exception {
    ...
    assertThat(
        getTreeString(),
        is("method {  { public },method: void,, { anInteger { anInteger: int } }, }"));
  ...
  public void methodDeclarationWithMultipleThrowsShouldBeConverted() throws Exception {
    ...
    convertMethod("method");
    assertThat(
        getTreeString(), is("method { ,method: void,,, { IOException,OutOfBoundException } }"));
    Node exceptions = getLastChild();
  ...
  public void typeDeclarationCompleteShouldBeConverted() throws Exception {
    ...
    assertThat(
        getTreeString(),
        is("Bar {  { protected,final }, { T },Number, { Serializable,Throwable } }"));
  }
  ...
  private String getSource(Node node) {
    ...
    return fCompilation
        .getSource()
        .substring(entity.getStartPosition(), entity.getEndPosition() + 1);
  }
  ...
  private void convertMethod(String name) {
    ...
    AbstractMethodDeclaration method =
        CompilationUtils.findMethod(fCompilation.getCompilationUnit(), name);
