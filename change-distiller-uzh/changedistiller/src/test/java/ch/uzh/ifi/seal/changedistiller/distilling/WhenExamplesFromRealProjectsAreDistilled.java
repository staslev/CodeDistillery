...
public class WhenExamplesFromRealProjectsAreDistilled {
  ...
  public void noStackOverflowErrorShouldOccur() throws Exception {
    ...
    try {
      ...
      fail(
          "Source code change extraction failed because of a stack overflow (most likely while doing a post-order traversal of T1 during the edit script generation).");
    }
  }
