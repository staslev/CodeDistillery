...
public class WhenStructureDifferencesAreExtracted {
  ...
  public void addedClassShouldBeFound() throws Exception {
    ...
    // for some reason a default ctor is generated as part of the compilation unit,
    // this ctor makes its way into diffs
  ...
  public void changedMethodInInnerClassShouldBeFound() throws Exception {
    ...
    createDifferences();
    StructureDiffNode changedMethod =
        fDiffs.getChildren().get(0).getChildren().get(0).getChildren().get(0);
