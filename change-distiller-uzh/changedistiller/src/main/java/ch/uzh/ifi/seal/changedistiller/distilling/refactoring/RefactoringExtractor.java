...
public final class RefactoringExtractor {
   ...
   *
   * <p>For instance, if a method was deleted from a class body and a new one was inserted, this
   * method checks whether the two operations reflect a refactoring.
   *
