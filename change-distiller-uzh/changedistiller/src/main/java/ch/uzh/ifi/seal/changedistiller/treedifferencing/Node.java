 ...
 * General tree node.
 *
 * <p>{@link TreeDifferencer} can only apply the matching and edit script generation if the two
 * trees are made out of such nodes.
 *
 * @author Beat Fluri
 * @see TreeDifferencer
 */
public class Node extends DefaultMutableTreeNode {
   ...
   * @return <code>true</code> if the candidate is a leaf and a descendant of this node, <code>false
   *     </code> otherwise
   */
