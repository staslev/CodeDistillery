...
public final class SourceCodeChangeConverter {
   ...
   *
   * <p>A {@link SourceCodeChange} is added if the conversion didn't result in a <code>null</code>
   * value.
   *
  ...
  public void addTreeEditOperationAsSourceCodeChange(TreeEditOperation operation) {
    ...
    switch (operation.getOperationType()) {
      case INSERT:
        scc =
            fSourceCodeChangeFactory.createInsertOperation(
                fStructureEntity, (InsertOperation) operation);
        break;
      case DELETE:
        scc =
            fSourceCodeChangeFactory.createDeleteOperation(
                fStructureEntity, (DeleteOperation) operation);
        break;
      case MOVE:
        scc =
            fSourceCodeChangeFactory.createMoveOperation(
                fStructureEntity, (MoveOperation) operation);
        break;
      case UPDATE:
        scc =
            fSourceCodeChangeFactory.createUpdateOperation(
                fStructureEntity, (UpdateOperation) operation);
        break;
      default:
