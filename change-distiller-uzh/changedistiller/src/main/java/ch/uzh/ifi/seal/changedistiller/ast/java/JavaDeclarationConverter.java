...
public class JavaDeclarationConverter extends ASTVisitor {
  ...
  private void visitAbstractMethodDeclaration(
    ...
    visitAbstractVariableDeclarations(
        JavaEntityType.TYPE_PARAMETERS, methodDeclaration.typeParameters());
  ...
  private void visitReturnType(
      AbstractMethodDeclaration abstractMethodDeclaration, ClassScope scope) {
  ...
  public boolean visit(
      ParameterizedSingleTypeReference parameterizedSingleTypeReference, ClassScope scope) {
  ...
  public boolean visit(SingleTypeReference type, BlockScope scope) {
    pushValuedNode(
        type, prefixWithNameOfParrentIfInMethodDeclaration() + String.valueOf(type.token));
    return false;
  }
  ...
  public boolean visit(TypeDeclaration typeDeclaration, BlockScope scope) {
    ...
    visitAbstractVariableDeclarations(
        JavaEntityType.TYPE_PARAMETERS, typeDeclaration.typeParameters);
  ...
  private void visitAbstractVariableDeclarations(
      JavaEntityType parentLabel, AbstractVariableDeclaration[] declarations) {
    int start = -1;
    int end = -1;
    ...
    if (isNotEmpty(typeParameters)) {
      ...
      if (lastNode instanceof ParameterizedQualifiedTypeReference) {
        TypeReference[][] typeArguments =
            ((ParameterizedQualifiedTypeReference) lastNode).typeArguments;
