 ...
 *
 * <p>Each source code change has a
 *
 * <ul>
 *   <li>{@link StructureEntityVersion} <code>rootEntity</code> that describes in which attribute,
 *       class, or method the changes was made. The <code>rootEntity</code> is taken from the right
 *       AST, i.e., new version of the {@link StructureEntityVersion}.
 *   <li>{@link SourceCodeEntity} <code>changedEntity</code> that describes which source code entity
 *       has changed. In case of
 *       <ul>
 *         <li>{@link Delete}: the entity that was deleted; it is taken from the left AST, i.e., old
 *             version.
 *         <li>{@link Insert}: the entity that was inserted; it is taken from the right AST, i.e.,
 *             new version.
...
public class SourceCodeChange {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(77, 103)
        .append(getChangeType())
        .append(getSignificanceLevel())
        .append(getChangedEntity())
        .append(getParentEntity())
        .append(getRootEntity())
        .toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
        .append(getChangeType(), other.getChangeType())
