 ...
 *
 * <p>In addition to the involved entities described in {@link SourceCodeChange} an insert has a
 *
 * <ul>
 *   <li>{@link SourceCodeEntity} <code>oldParentEntity</code> that describes from which entity
 *       <code>changedEntity</code> is deleted. Speaking of an AST, <code>parentEntity</code>
 *       describes the node in which <code>changedEntity</code> was a child before move. <code>
 *       parentEntity</code> is taken from the left AST, i.e., old version.
 *   <li>{@link SourceCodeEntity} <code>newParentEntity</code> that describes in which entity <code>
 *       changedEntity</code> is inserted. Speaking of an AST, <code>parentEntity</code> describes
 *       the node in which <code>changedEntity</code> will be a child after the move. <code>
 *       parentEntity</code> is taken from the left AST, i.e., old version. In case <code>
 *       parentEntity</code> was inserted (see {@link SourceCodeChange}), it is taken from the right
 *       AST.
 *   <li>{@link SourceCodeEntity} <code>newEntity</code> that describes which entity <code>
 *       changedEntity</code> becomes after the move. <code>newEntity</code> is taken from the right
 *       AST, i.e., new version.
 * </ul>
 *
 * @author Beat Fluri
...
public class Move extends SourceCodeChange {
   ...
   *
   * <p>The moved entity is moved from the old to the new parent entity inside the structure entity.
   *
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
        ...
        .append(getNewParentEntity(), other.getNewParentEntity())
        .isEquals();
  }
