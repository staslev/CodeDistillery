 ...
 *
 * <p>In addition to the involved entities described in {@link SourceCodeChange} a delete has a
 *
 * <ul>
 *   <li>{@link SourceCodeEntity} <code>parentEntity</code> that describes from which entity <code>
 *       changedEntity</code> is deleted. Speaking of an AST, <code>parentEntity</code> describes
 *       the node in which <code>changedEntity</code> was a child before the delete. <code>
...
public class Delete extends SourceCodeChange {
   ...
   *
   * <p>The deleted entity is deleted as child of parent entity inside the structure entity.
   *
