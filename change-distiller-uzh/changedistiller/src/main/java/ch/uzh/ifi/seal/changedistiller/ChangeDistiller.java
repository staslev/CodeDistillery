...
import ch.uzh.ifi.seal.changedistiller.distilling.ContentDistiller;
...
public final class ChangeDistiller {
  ...
  public static ContentDistiller createContentDistiller(Language language) {
    switch (language) {
      case JAVA:
        Injector injector = Guice.createInjector(new JavaChangeDistillerModule());
        return injector.getInstance(ContentDistiller.class);
    }
    return null;
  }
