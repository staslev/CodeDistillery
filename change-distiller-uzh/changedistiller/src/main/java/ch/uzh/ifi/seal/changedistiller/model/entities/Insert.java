 ...
 *       the node in which <code>changedEntity</code> will be a child after the insert. <code>
...
public class Insert extends SourceCodeChange {
   ...
   *
   * <p>The inserted entity is inserted as a child of parent entity inside the structure entity.
   *
