 ...
 *
 * <p>Each type contains a {@link SignificanceLevel}, is marked whether it is a body change (e.g.
 * found inside a method body) or not and whether its significance level is unstable and may be
 * lifted (e.g. for a method renaming, the significance gets lifted if the method is public or
 * protected).
 *
 * @author zubi
...
public enum ChangeType {
  ...
  private ChangeType(
      SignificanceLevel level, boolean isBodyChange, boolean hasUnstableSignificanceLevel) {
    fSignificance = level;
