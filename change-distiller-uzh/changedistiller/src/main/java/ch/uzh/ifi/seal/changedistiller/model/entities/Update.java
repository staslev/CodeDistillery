 ...
 *
 * <p>In addition to the involved entities described in {@link SourceCodeChange} an update has a
 *
 * <ul>
 *   <li>{@link SourceCodeEntity} <code>newEntity</code> that describes which entity <code>
 *       changedEntity</code> becomes after the update. <code>newEntity</code> is taken from the
 *       right AST, i.e., new version.
 *   <li>{@link SourceCodeEntity} <code>parentEntity</code> that describes in which entity <code>
 *       changedEntity</code> is updated. Speaking of an AST, <code>parentEntity</code> describes
 *       the node in which <code>changedEntity</code> is a child before and after the update. <code>
...
public class Update extends SourceCodeChange {
   ...
   *
   * <p>The updated entity is updated to new entity as a child of parent entity in structure entity.
   *
