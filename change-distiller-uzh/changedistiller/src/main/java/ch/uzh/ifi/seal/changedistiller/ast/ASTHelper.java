...
public interface ASTHelper<T extends StructureNode> {
   ...
   */
  StructureEntityVersion createMethodInClassHistory(
      ClassHistory classHistory, T node, String version);
   ...
   */
  StructureEntityVersion createFieldInClassHistory(
      ClassHistory classHistory, T node, String version);
   ...
   */
  StructureEntityVersion createInnerClassInClassHistory(
      ClassHistory classHistory, T node, String version);
