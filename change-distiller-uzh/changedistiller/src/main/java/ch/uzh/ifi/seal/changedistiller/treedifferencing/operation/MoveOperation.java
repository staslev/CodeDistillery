...
public class MoveOperation implements TreeEditOperation {
   ...
   * @param newNode the node the moved node becomes
   * @param parent the parent node in which the node becomes a child after move
   * @param position the position of the node to move
   */
  ...
  public String toString() {
    ...
    sb.append(
        fNodeToMove.toString() + LEFT_PARENTHESIS + fNodeToMove.getLabel() + RIGHT_PARENTHESIS);
    sb.append("\nas child of: ");
