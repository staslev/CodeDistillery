...
public class StructureDiffNode {
   ...
   *
   * @return <code>true</code> if the diff node is related to a class or interface, <code>false
   *     </code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the diff node is related to a method or constructor, <code>false
   *     </code> otherwise
   */
