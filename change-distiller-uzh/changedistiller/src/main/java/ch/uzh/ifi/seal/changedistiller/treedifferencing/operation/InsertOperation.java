...
public class InsertOperation implements TreeEditOperation {
   ...
   * @param parent the parent in which the node is inserted
   * @param position the position of the node to insert
   */
  ...
  public String toString() {
    ...
    sb.append(
        fNodeToInsert.toString() + LEFT_PARENTHESIS + fNodeToInsert.getLabel() + RIGHT_PARENTHESIS);
    sb.append("\nas child of: ");
